...
//        }
        bootstrap.remoteAddress(Constants.getGps_host(), Integer.parseInt(Constants.getGps_port()));
        ...
        try {
            future = bootstrap.connect(new InetSocketAddress(Constants.getGps_host(), Integer.parseInt(Constants.getGps_port()))).sync();
            if (future.isSuccess()) {
